 ...
 * @author pros
 */
public class IsolationTankDisplayLeft extends JPanel implements ActionListener, MouseListener {
    ...
    public IsolationTankDisplayLeft()
    {
             ...
             if(PipeFromGUI.getIsolationTankObjects().has("FISH"))
                {
                    ...
                    isolationObject=array.getJSONObject(0);                    
                }              
            }
